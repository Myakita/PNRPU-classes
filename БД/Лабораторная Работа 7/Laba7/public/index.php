...
<body>
    ...
    <div class="container">
        ...
        <div class="operations">
            ...
            <h2>Представления</h2>
			<input type="text" id="insertnameview1" placeholder="Название первого представления">
            <button onclick="sendRequest('view1', {
				nameview: document.getElementById('insertnameview1').value, 
				name: document.getElementById('insertName').value, 
                phone: document.getElementById('insertPhone').value, 
                salary: document.getElementById('insertSalary').value,
                adress: document.getElementById('insertAdress').value,
                years: document.getElementById('insertYears').value})">Вывести представление 1</button>
        
            <input type="text" id="insertnameview2" placeholder="Название второго представления">
			<button onclick="sendRequest('view2', {
				nameview: document.getElementById('insertnameview2').value, 
				name: document.getElementById('insertName').value, 
                phone: document.getElementById('insertPhone').value, 
                salary: document.getElementById('insertSalary').value,
                adress: document.getElementById('insertAdress').value,
                years: document.getElementById('insertYears').value})">Вывести представление 2</button>
        
            <input type="text" id="insertnameview3" placeholder="Название третьего представления">
			<button onclick="sendRequest('view3', {
				nameview: document.getElementById('insertnameview3').value, 
				name: document.getElementById('insertName').value, 
                phone: document.getElementById('insertPhone').value, 
                salary: document.getElementById('insertSalary').value,
                adress: document.getElementById('insertAdress').value,
                years: document.getElementById('insertYears').value})">Вывести представление 3</button>
				
			<h3>Добавить сотрудника через хранимую процедуру</h3>
				<input type="text" id="insertName1" placeholder="ФИО">
				<input type="text" id="insertPhone1" placeholder="Телефон">
				<input type="number" id="insertSalary1" placeholder="ЗП">
				<input type="text" id="insertAdress1" placeholder="Адрес">
				<input type="number" id="insertYears1" placeholder="Трудовая деятельность (года)">
				<button onclick="sendRequest('insert_proc', {
				name: document.getElementById('insertName1').value,
				phone: document.getElementById('insertPhone1').value,
				salary: document.getElementById('insertSalary1').value,
				adress: document.getElementById('insertAdress1').value,
				years: document.getElementById('insertYears1').value
				})">Добавить через хранимую процедуру</button>
				
			<h3>Удалить хранимую процедуру</h3>
				<input type="text" id="procName" placeholder="Название процедуры">
				<button onclick="sendRequest('drop_proc', { procName: document.getElementById('procName').value })">Удалить процедуру</button>
			
			<h3>Просмотр хранимых процедур</h3>
				<button onclick="sendRequest('view_procs', {})">Показать процедуры</button>
